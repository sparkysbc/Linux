...
#define PCM512x_CRAM_CTRL         (PCM512x_PAGE_BASE(180) +  1)

#define PCM512x_MAX_REGISTER      (PCM512x_PAGE_BASE(180) +  1)
...
int pcm512x_set_reg(int dac_num, unsigned int reg, unsigned int val);
int pcm512x_get_reg(int dac_num, unsigned int reg, unsigned int *val);
